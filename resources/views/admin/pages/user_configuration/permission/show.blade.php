        ...
        <div class="col-md-12">
            <div class="card">
                <form action="{{ route('admin.user_config.permission.update', [$data['role']->id]) }}" method="POST">
                                        ...
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    data-id="{{ $grubCounter }}" type="checkbox"
                                                    value="{{ $permission->id }}" name="permission[]" @if (isset($data['rolePermissions'][$permission->id]))
                                                {{ 'checked' }}
                                                @php
                                                    $checkedCounter++;
                                                @endphp
                    ...
                    <div class="row pt-2">
                        <div class="col-md-12">
                            <small class="mt-2">Perizinan <strong>view</strong> akan otomatis terisi jika
                                perizinan
